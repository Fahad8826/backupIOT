...
from .views import (
    ...
    FarmMotorsListView, MotorValveUpdate,  # ✅ Add this new view for listing motors in a farm
)
...
urlpatterns = [
    ...
    path('motors/<str:UIN>/', MotorDetailView.as_view(), name='motor-detail'),
    ...
    path('motors/<int:UIN>/<int:valve_id>/', MotorValveUpdate.as_view(), name='motor-valve-update'),
