...
# For development: This ensures Django looks in the correct static directories
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),
]

# For production: This is where `collectstatic` will store static files
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')

# Enable static files in debug mode
DEBUG = True
